---
title: Introduction
description: Larasonic is a modern Laravel boilerplate for the **VILT** stack (**Vue**, **Inertia**, **Laravel**, **TailwindCSS**).
icon: 'book'
---
...
- **[TailwindCSS 4+](https://tailwindcss.com)**: Rapidly style your UI with utility-first CSS.
...
- **[echolabs/prism](https://github.com/echolabsdev/prism)**: AI integrations for Laravel.
- **[spatie/laravel-sitemap](https://github.com/spatie/laravel-sitemap)**: Sitemap generation for Laravel.
- **[unhead](https://unhead.unjs.io/)**: Unhead is the document head manager built for performance and delightful developer experience.
---
